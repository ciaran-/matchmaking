...
function RouteComponent() {
	...
	const [_replayEvents, _setReplayEvents] = useState<string[]>([]);
	...
	return (
		<>
			<style
				// biome-ignore lint/security/noDangerouslySetInnerHtml: demo page CSS injection is intentional
